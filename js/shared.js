  ...
  <div class="modal">
    ...
    <div id="auth-form">
      ...
      <div class="form-group" id="invite-code-group" style="display: none;">
        ...
        <input type="text" id="auth-invite-code" placeholder="e.g. VIBE-A3X9" autocomplete="off" style="text-transform: uppercase;">
        <div class="username-status" id="invite-status"></div>
      </div>
      <div class="form-group">
